...
-- 1. Tabla de Roles 
CREATE TABLE roles (
    id INT AUTO_INCREMENT PRIMATY KET,
...
CRATE TABLE usuarios (
    ...
    creado_en TIMESTAMP DEFAULT CUREENT_TIMESTAMP,
    FOREIGN KEY (rol_id) REFERENCES roles(id) ON DELTE RESTRICT ON UPDATE CASCADE
...
CREATE TABLE reclamos (
    ...
    responsable_id INTdefault NULL,
    ...
    CONSTRAINT chk_estado CHECK (estados IN ('PENDIENTE', 'EN_REVISION', 'RESUELTO', 'ANULADO'))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
